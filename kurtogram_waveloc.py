# -*- coding: utf-8 -*-
"""
Created on Thu Jul 11 14:21:38 2019
...
def plotKurtogram(Kwav, freq_w, nlevel, Level_w, Fs=1):
    """
    Plots the kurtogram.
    ...
    plt.plot(Fs*fi,I,'yo') #
    plt.xlabel("Frequency (Hz/samples)")
    plt.ylabel("Level k")
    #plt.gtext(0.075, 0.90, "(a)", fontsize=15)
